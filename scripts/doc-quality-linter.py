...
def main():
    ...
    parser = argparse.ArgumentParser(description="Documentation Quality Linter")
    parser.add_argument("--path", default=".", help="Path to project root")
    parser.add_argument("--format", choices=["text", "json"], default="text", help="Output format")
    parser.add_argument("--exit-code", action="store_true", help="Exit with non-zero code if issues found")
    
    args = parser.parse_args()
    
    linter = DocumentationQualityLinter(args.path)
    issues = linter.lint_project()
