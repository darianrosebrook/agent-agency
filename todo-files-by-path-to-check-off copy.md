...
- `agent-agency-contracts/src/engine.rs` - **1** TODOs
- `agent-agency-contracts/src/execution_artifacts.rs` - **1** TODOs
- `agent-agency-contracts/src/invariants.rs` - **9** TODOs
- `agent-agency-contracts/src/task_executor_provider.rs` - **1** TODOs

# agent-constitutional-council/
- `agent-constitutional-council/src/invariants.rs` - **7** TODOs
- `agent-constitutional-council/src/judges/technical_auditor.rs` - **1** TODOs
- `agent-constitutional-council/src/metrics.rs` - **1** TODOs

# agent-data-processing/
- `agent-data-processing/src/context/manager.rs` - **8** TODOs
- `agent-data-processing/src/data_processing_types.rs` - **1** TODOs
- `agent-data-processing/src/enrichment.rs` - **4** TODOs
...
# agent-mcp/
- `agent-mcp/src/lib.rs` - **1** TODOs
- `agent-mcp/src/mcp_caws_integration.rs` - **5** TODOs
- `agent-mcp/src/server.rs` - **20** TODOs
- `agent-mcp/src/tool_discovery/core.rs` - **1** TODOs
- `agent-mcp/src/tool_discovery/filesystem.rs` - **1** TODOs
- `agent-mcp/src/tool_registry.rs` - **16** TODOs
