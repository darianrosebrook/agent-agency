...
// Mock RedisCache before importing MultiLevelCache
...
describe("MultiLevelCache", () => {
  ...
  beforeEach(() => {
    ...
    // Set up the RedisCache mock implementation
    const RedisCacheMock =
      require("../../../src/data/cache/RedisCache").RedisCache;
  ...
  describe("initialization", () => {
    it("should initialize successfully", async () => {
      // Mock Redis initialize to resolve immediately
      mockRedisCache.initialize.mockResolvedValue(undefined);
  ...
  describe("error handling", () => {
    it("should handle initialization failures", async () => {
      mockRedisCache.initialize.mockRejectedValue(
        new Error("Redis init failed")
      );
