...
// Mock evaluation orchestrator
jest.mock("../../src/mcp/evaluation/EvaluationOrchestrator.js", () => ({
  BaseEvaluator: class BaseEvaluator {
    async evaluate() {
      return { score: 1.0, criteria: [], passed: true };
    }
  },
