...
> implements IBaseDAO<T>
{
  ...
  async create(
    ...
    try {
      ...
      return formatQueryResult(true, createdEntity);
    } catch (error) {
  ...
  async findById(
    ...
    try {
      ...
      return formatQueryResult(true, entity);
    } catch (error) {
  ...
  async findMany(
    ...
    try {
      ...
      return formatQueryResult(true, entities);
    } catch (error) {
  ...
  async update(
    ...
    try {
      this.validateUpdates(updates as Partial<T>);
      ...
      return formatQueryResult(true, updatedEntity);
    } catch (error) {
  ...
  async delete(
    ...
    try {
      ...
      return formatQueryResult(true, true);
    } catch (error) {
  ...
  async exists(
    ...
    try {
      ...
      return formatQueryResult(true, result.data?.[0]?.exists || false);
    } catch (error) {
  ...
  async count(
    ...
    try {
      ...
      return formatQueryResult(true, parseInt(result.data[0].count.toString()));
    } catch (error) {
