...
// Moved from caws_checker.rs: ProgrammingLanguage enum (duplicate removed)



// Moved from caws_checker.rs: LanguageAnalysisResult struct (duplicate removed)



// Moved from caws_checker.rs: LanguageViolation struct (duplicate removed)
// Moved from caws_checker.rs: SourceLocation struct (duplicate removed)
