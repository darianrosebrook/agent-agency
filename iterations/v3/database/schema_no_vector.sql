...
-- CREATE EXTENSION IF NOT EXISTS "pgvector"; -- Not available in this setup
...
CREATE TABLE knowledge_entries (
    ...
    -- embedding VECTOR (1536), -- OpenAI ada-002 embedding dimension - disabled for now
    created_at TIMESTAMP
    WITH
        TIME ZONE DEFAULT NOW(),
        updated_at TIMESTAMP
...
-- WITH (lists = 100); -- Disabled - no vector support
