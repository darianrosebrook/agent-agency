...
use crate::models::coreml_model::LoadedCoreMLModel;
...
pub fn update_performance_metrics(
    current_metrics: &mut crate::manager::ANEPerformanceMetrics,
    ...
    if new_result.memory_usage_mb > current_metrics.memory_usage_mb {
        current_metrics.memory_usage_mb = new_result.memory_usage_mb;
    }
...
mod tests {
    use super::*;
    use crate::models::coreml_model::{ModelMetadata, ModelSchema, IOTensorSpec, DType};
    ...
    fn test_performance_metrics_update() {
        let mut metrics = crate::manager::ANEPerformanceMetrics {
            total_inferences: 0,
