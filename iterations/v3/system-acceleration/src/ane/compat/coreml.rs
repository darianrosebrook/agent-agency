...
pub use crate::ane::compat::coreml_module::{
    compile_model, detect_coreml_capabilities, is_ane_available, load_model,
    load_model_with_config, query_model_inputs, query_model_outputs, run_inference, ComputeUnits,
    ModelIOSpec,
};
