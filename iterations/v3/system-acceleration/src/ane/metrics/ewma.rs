...
impl Ewma {
    ...
    pub fn update_adaptive(prev: f64, sample: f64, base_alpha: f64, variance: f64) -> f64 {
    ...
    pub fn update_with_trend(prev: f64, sample: f64, alpha: f64, trend_samples: &[f64]) -> f64 {
        ...
        let sum_xy = trend_samples
            .iter()
            .enumerate()
            .map(|(i, &y)| i as f64 * y)
            .sum::<f64>();
        let sum_x2 = (0..trend_samples.len())
    ...
    pub fn update_seasonal(prev: f64, sample: f64, alpha: f64, seasonal_factor: f64) -> f64 {
    ...
    pub fn update_with_confidence(prev: f64, sample: f64, alpha: f64, confidence: f64) -> f64 {
    ...
    /// # Returns
    /// * Updated EWMA value
    pub fn update_weighted(prev: f64, samples: &[f64], weights: &[f64], alpha: f64) -> f64 {
...
impl PerformanceTracker {
    ...
    pub fn update_latency(&mut self, latency_ms: f64) {
        self.latency_ewma = Ewma::update(self.latency_ewma, latency_ms, self.alphas.latency);
    ...
    pub fn update_throughput(&mut self, throughput_ips: f64) {
        self.throughput_ewma =
            Ewma::update(self.throughput_ewma, throughput_ips, self.alphas.throughput);
        self.sample_counts.throughput += 1;
    }

    /// Update memory usage metric
    pub fn update_memory(&mut self, memory_mb: f64) {
        self.memory_ewma = Ewma::update(self.memory_ewma, memory_mb, self.alphas.memory);
    ...
    pub fn update_error_rate(&mut self, error_rate: f64) {
        self.error_rate_ewma =
            Ewma::update(self.error_rate_ewma, error_rate, self.alphas.error_rate);
