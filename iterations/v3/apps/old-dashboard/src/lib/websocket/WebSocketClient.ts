...
export class WebSocketClient {
  ...
  private scheduleReconnect() {
    ...
    console.log(
      `Scheduling reconnect attempt ${this.reconnectAttempts}/${this.options.maxReconnectAttempts} in ${delay}ms`
    );
  ...
  sendMessage(
    content: string,
    context?: ChatMessagePayload["context"],
    intentHint?: ChatMessagePayload["intent_hint"]
  ) {
