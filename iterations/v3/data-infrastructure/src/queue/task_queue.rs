...
impl TaskQueueError {
    ...
    /// For now, converts to Generic since extracting sqlx::Error from anyhow::Error
    /// requires unstable features. This can be refined later if needed.
    fn from_anyhow(error: anyhow::Error) -> Self {
        ...
        if error_string.contains("database") || error_string.contains("sqlx") {
            ...
            // For now, just use Generic with the error message
