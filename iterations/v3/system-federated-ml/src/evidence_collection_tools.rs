...
use crate::evidence_types::{
    ClaimExtractionResult, EvidenceMetadata, EvidenceResult, ProcessingConfig, ProcessingContext,
    SourceCredibility, VerificationResult, VerificationStatus,
};
...
impl EvidenceCollectionTool {
    ...
    pub async fn collect_evidence(
        ...
        for (task_idx, task) in tasks.iter().enumerate() {
            ...
            total_claims_verified += verification_results
                .iter()
    ...
    fn determine_content_type(&self, task: &serde_json::Value, content: &str) -> String {
            ...
            || content_lower.contains("code")
        {
            ...
            || content_lower.contains("finding")
        {
            "research".to_string()
    ...
    fn calculate_overall_confidence(
        ...
        let verification_score = if verification_results.is_empty() {
            ...
            let avg_confidence: f64 = verification_results
                ...
                .map(|r| r.confidence)
                .sum::<f64>()
                / verification_results.len() as f64;
            avg_confidence
        };
