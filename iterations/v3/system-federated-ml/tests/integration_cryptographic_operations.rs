...
async fn test_secure_aggregator_with_real_cryptography() {
    ...
    // Create aggregator with real Paillier encryption
    ...
    // Start an aggregation round
    aggregator.start_round(1, 3).await.unwrap();
    
    // Create a model update with ZKP proof
    ...
    // Accept encrypted update with ZKP
    ...
    // Should succeed with valid proof and encryption
