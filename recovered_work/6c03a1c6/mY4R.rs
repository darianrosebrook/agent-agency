...
impl MetricsCollector for InMemoryMetricsCollector {
    ...
    async fn update_quantiles(&self, _metric_name: &str, _value: f64, _quantiles: &mut BTreeMap<OrderedFloat<f64>, f64>) -> Result<(), ObservabilityError> {
    ...
    async fn merge_quantile_estimators(&self, _source_estimators: HashMap<String, QuantileEstimator>) -> Result<(), ObservabilityError> {
        // TODO: Add this method to MetricsCollector trait in observability crate
        // let mut estimators = self.quantile_estimators.write().await;
    ...
    async fn get_quantile_error_bounds(&self, _metric_name: &str, _quantile: f64) -> Result<Option<QuantileErrorBounds>, ObservabilityError> {
        // TODO: Add this method to MetricsCollector trait in observability crate
    ...
    // TODO: Add this method to MetricsCollector trait in observability crate
    async fn configure_quantile_estimation(&self, _metric_name: &str, _config: QuantileConfig) -> Result<(), ObservabilityError> {
        // TODO: Add this method to MetricsCollector trait in observability crate
        // let mut estimators = self.quantile_estimators.write().await;
    ...
    // TODO: Add this method to MetricsCollector trait in observability crate
    async fn get_quantile_alerts(&self) -> Result<Vec<QuantileAlert>, ObservabilityError> {
    ...
    // TODO: Add this method to MetricsCollector trait in observability crate
    async fn optimize_quantile_estimators(&self) -> Result<(), ObservabilityError> {
