...
export function DebateVisualization({ taskId }: DebateVisualizationProps) {
  const { data: debateResult, loading, error } = useDebateData(taskId);
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-center">
            ...
            <span className="ml-2 text-gray-600">Loading debate data...</span>
          </div>
        </CardContent>
      </Card>
    );
      ...
      <Card>
        <CardContent className="p-6">
          <div className="text-center text-gray-500">
            ...
            <p>Failed to load debate data: {error}</p>
          </div>
        </CardContent>
      </Card>
    );
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="text-center">
            <div className="text-2xl font-bold text-purple-600">
              #{debateResult.winningOutputIndex + 1}
            </div>
        ...
        {debateResult.debateTranscript &&
          debateResult.debateTranscript.length > 0 && (
              ...
              <div className="space-y-2">
                {debateResult.debateTranscript.map((round, index) => (
                  <div
                    ...
                    onClick={() =>
                      setSelectedRound(selectedRound === index ? null : index)
                    }
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-medium">
                          {round.participants.length} models
                        </span>
                        <ChevronRight
                          className={`w-4 h-4 transition-transform ${
                            selectedRound === index ? "rotate-90" : ""
                          }`}
                        />
                      </div>
                      <div className="flex items-center gap-2">
        ...
        <Tabs defaultValue="claims" className="w-full">
          ...
          <TabsContent value="claims" className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="text-2xl font-bold">
                {debateResult.evidenceManifest.claims.length}
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center">
                <div className="text-xl font-bold text-green-600">
                  {
                    debateResult.evidenceManifest.verificationResults.filter(
              ...
              <div className="text-center">
                <div className="text-xl font-bold text-blue-600">
                  {(
                    (debateResult.evidenceManifest.claims.reduce(
          ...
          <TabsContent value="evidence" className="space-y-4">
            <div className="space-y-3">
              {debateResult.evidenceManifest.verificationResults
                .slice(0, 5)
                .map((result, index) => (
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ul className="text-sm text-blue-800 space-y-1">
            <li>
              • {debateResult.debateRounds} rounds of cross-examination improved
              factual accuracy by{" "}
              {(debateResult.factualAccuracyScore * 100 - 70).toFixed(0)}%
            </li>
            <li>
              • {debateResult.evidenceManifest.claims.length} claims were
