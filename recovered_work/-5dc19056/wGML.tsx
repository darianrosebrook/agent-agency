    ...
    <div className={styles.trendAnalyzer}>
      <div className={styles.analyzerHeader}>
        ...
        <p className={styles.description}>
          Statistical analysis of metric trends using linear regression, seasonal decomposition, and forecasting models.
        </p>
        ...
        {state.isAnalyzing ? (
          ...
          <>
            <div className={styles.trendsHeader}>
              ...
              <div className={styles.trendsStats}>
                <span>
                  Increasing: {state.trends.filter((t) => t.direction === "increasing").length}
                </span>
                <span>
                  Decreasing: {state.trends.filter((t) => t.direction === "decreasing").length}
                </span>
                <span>
                  Stable: {state.trends.filter((t) => t.direction === "stable").length}
                </span>
                <span>
                  Volatile: {state.trends.filter((t) => t.direction === "volatile").length}
                </span>
              </div>
            </div>
              ...
              {state.trends.map((trend) => (
                <div
                  ...
                  className={`${styles.trendCard} ${
                    state.selectedTrend?.metric === trend.metric ? styles.selected : ""
                  }`}
                  onClick={() => handleTrendSelect(trend)}
                >
                  <div className={styles.trendHeader}>
                    <div className={styles.trendTitle}>
                      <span className={`${styles.directionIcon} ${getDirectionColor(trend.direction)}`}>
                        {getDirectionIcon(trend.direction)}
                      </span>
                      <span className={styles.trendMetric}>{trend.metric}</span>
                      <span className={`${styles.directionBadge} ${getDirectionColor(trend.direction)}`}>
                      ...
                      <div className={styles.trendForecast}>
                        ...
                        <div className={styles.forecastDetails}>
                          <div className={styles.forecastItem}>
                            <span className={styles.forecastLabel}>Next Value:</span>
                            <span className={styles.forecastValue}>
                              {trend.forecast.next_value.toFixed(2)}
                            </span>
                          </div>
                          <div className={styles.forecastItem}>
                            <span className={styles.forecastLabel}>Confidence Interval:</span>
                            <span className={styles.forecastValue}>
                          ...
                          <div className={styles.forecastItem}>
                            ...
                            <span className={styles.forecastValue}>
                              {new Date(trend.forecast.timestamp).toLocaleDateString()}
                            </span>
                          </div>
                        </div>
                      </div>
          ...
          <div className={styles.noTrends}>
            ...
            <p>
              ...
              This could indicate stable system performance or insufficient data.
            </p>
      ...
      {state.selectedTrend && (
        <div className={styles.trendSidebar}>
          <div className={styles.sidebarHeader}>
            <h3>Trend Details</h3>
            <button
              onClick={() => setState((prev) => ({ ...prev, selectedTrend: null }))}
            ...
            <div className={styles.detailSection}>
              ...
              <div className={styles.detailGrid}>
                <div className={styles.detailItem}>
                  ...
                  <span className={`${styles.detailValue} ${getDirectionColor(state.selectedTrend.direction)}`}>
            ...
            {state.selectedTrend.forecast && (
              <div className={styles.detailSection}>
                ...
                <div className={styles.forecastGrid}>
                  <div className={styles.forecastItem}>
                    <span className={styles.forecastLabel}>Predicted Value:</span>
                    <span className={styles.forecastValue}>
                  ...
                  <div className={styles.forecastItem}>
                    ...
                    <span className={styles.forecastValue}>
                      {state.selectedTrend.forecast.confidence_interval[0].toFixed(4)}
                    </span>
                  </div>
                  <div className={styles.forecastItem}>
                    <span className={styles.forecastLabel}>Upper Bound:</span>
                    <span className={styles.forecastValue}>
                      {state.selectedTrend.forecast.confidence_interval[1].toFixed(4)}
                    </span>
                  </div>
                  <div className={styles.forecastItem}>
                    <span className={styles.forecastLabel}>Forecast Date:</span>
                    <span className={styles.forecastValue}>
                      {new Date(state.selectedTrend.forecast.timestamp).toLocaleDateString()}
                    </span>
                  </div>
                </div>
              </div>
