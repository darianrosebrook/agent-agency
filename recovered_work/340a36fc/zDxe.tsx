...
export default function ContextPanel({
  ...
  const [editedContext, setEditedContext] =
    useState<Partial<ChatContext>>(context);
  ...
  const updateContext = (field: keyof ChatContext, value: unknown) => {
        ...
        <div className={styles.section}>
          ...
          {isEditing ? (
            ...
            <div className={styles.value}>
              ...
              context.conversation_goals.length > 0 ? (
        ...
        {context.repository_context && (
          <div className={styles.section}>
            ...
            <div className={styles.repoContext}>
              ...
              {context.repository_context.recent_commits &&
                context.repository_context.recent_commits.length > 0 && (
                  <div className={styles.repoField}>
              ...
              {context.repository_context.active_files &&
                context.repository_context.active_files.length > 0 && (
                  <div className={styles.repoField}>
        ...
        <div className={styles.section}>
          ...
          <div className={styles.sessionInfo}>
            <div className={styles.sessionField}>
              ...
              <span
                className={`${styles.fieldValue} ${styles[session.status]}`}
              >
                {session.status}
              </span>
            </div>
            <div className={styles.sessionField}>
              ...
              <span className={styles.fieldValue}>{session.message_count}</span>
            </div>
            <div className={styles.sessionField}>
