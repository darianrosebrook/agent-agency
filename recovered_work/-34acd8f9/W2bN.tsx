...
export default function CoordinationMetrics({
    ...
    return (
      <div className={styles.coordinationMetrics}>
        <div className={styles.emptyState}>
          ...
          <p>Real-time agent coordination monitoring requires V3 coordination metrics APIs.</p>
    ...
    <div className={styles.coordinationMetrics}>
      ...
      <div className={styles.metricsGrid}>
        <MetricTile
          ...
          status={metrics.consensus_rate >= 0.95 ? "success" : metrics.consensus_rate >= 0.8 ? "warning" : "error"}
          icon="🎯"
          format="percentage"
        />
        ...
        <MetricTile
          ...
          status={metrics.average_decision_time_ms < 5000 ? "success" : metrics.average_decision_time_ms < 15000 ? "warning" : "error"}
          icon="⏱️"
          format="duration"
        />
        ...
        <MetricTile
          ...
          status={metrics.failed_decisions === 0 ? "success" : metrics.failed_decisions < 5 ? "warning" : "error"}
          icon="❌"
        />
      </div>
      ...
      <div className={styles.taskCoordination}>
        ...
        <div className={styles.taskMetrics}>
          ...
          <MetricTile
            ...
            status={metrics.queued_tasks > 10 ? "warning" : metrics.queued_tasks > 50 ? "error" : "success"}
            icon="📋"
          />
          ...
          <MetricTile
            ...
            status={metrics.completed_tasks_per_hour > 5 ? "success" : metrics.completed_tasks_per_hour > 2 ? "warning" : "error"}
            icon="📈"
          />
          ...
          <MetricTile
            ...
            status={metrics.average_task_duration_ms < 300000 ? "success" : metrics.average_task_duration_ms < 900000 ? "warning" : "error"}
            icon="⏱️"
            format="duration"
          />
        </div>
      ...
      <div className={styles.communicationMetrics}>
        ...
        <div className={styles.commMetrics}>
          <MetricTile
            ...
            status={metrics.inter_agent_messages_per_minute < 1000 ? "success" : "warning"}
            icon="💬"
          />
          ...
          <MetricTile
            ...
            status={metrics.average_message_latency_ms < 100 ? "success" : metrics.average_message_latency_ms < 500 ? "warning" : "error"}
            icon="⚡"
            format="duration"
          />
          ...
          <MetricTile
            ...
            status={metrics.message_failure_rate < 0.01 ? "success" : metrics.message_failure_rate < 0.05 ? "warning" : "error"}
            icon="🔄"
            format="percentage"
          />
        </div>
      ...
      <div className={styles.coordinationHealth}>
        ...
        <div className={styles.healthIndicators}>
          <div className={styles.indicator}>
            <div className={styles.indicatorLabel}>
              <span className={styles.indicatorIcon}>
                {metrics.consensus_rate >= 0.9 ? "✅" : metrics.consensus_rate >= 0.7 ? "⚠️" : "❌"}
              </span>
              <span>Consensus Stability</span>
            </div>
            <div className={styles.indicatorValue}>
              {metrics.consensus_rate >= 0.9 ? "Healthy" : metrics.consensus_rate >= 0.7 ? "Degraded" : "Unhealthy"}
            </div>
          </div>
          ...
          <div className={styles.indicator}>
            <div className={styles.indicatorLabel}>
              <span className={styles.indicatorIcon}>
                {metrics.message_failure_rate < 0.02 ? "✅" : metrics.message_failure_rate < 0.1 ? "⚠️" : "❌"}
              </span>
              <span>Communication Reliability</span>
            </div>
            <div className={styles.indicatorValue}>
              {metrics.message_failure_rate < 0.02 ? "Excellent" : metrics.message_failure_rate < 0.1 ? "Good" : "Poor"}
            </div>
          </div>
          ...
          <div className={styles.indicator}>
            <div className={styles.indicatorLabel}>
              <span className={styles.indicatorIcon}>
                {metrics.average_decision_time_ms < 10000 ? "✅" : metrics.average_decision_time_ms < 30000 ? "⚠️" : "❌"}
              </span>
              <span>Decision Speed</span>
            </div>
            <div className={styles.indicatorValue}>
              {metrics.average_decision_time_ms < 10000 ? "Fast" : metrics.average_decision_time_ms < 30000 ? "Moderate" : "Slow"}
            </div>
          </div>
          ...
          <div className={styles.indicator}>
            <div className={styles.indicatorLabel}>
              <span className={styles.indicatorIcon}>
                {metrics.queued_tasks < 20 ? "✅" : metrics.queued_tasks < 100 ? "⚠️" : "❌"}
              </span>
              <span>Queue Health</span>
            </div>
            <div className={styles.indicatorValue}>
              {metrics.queued_tasks < 20 ? "Clear" : metrics.queued_tasks < 100 ? "Backed up" : "Overloaded"}
            </div>
          </div>
        </div>
      </div>
