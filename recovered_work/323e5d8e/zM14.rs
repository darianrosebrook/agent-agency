...
use crate::caws_integration::{CawsValidator, ValidationContext, ValidationStatus, ValidationResults, ValidationIssue, IssueSeverity};
...
impl ValidationPipeline {
    ...
    pub async fn validate_working_spec(
        ...
        all_issues.extend(caws_result.issues);
    ...
    async fn validate_schema(
        ...
        match result {
            Ok(()) => Ok(Vec::new()),
            Err(crate::error::ContractError::Validation { issues, .. }) => {
