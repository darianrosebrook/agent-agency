      ...
      <div className={styles.headerContent}>
        ...
        <div className={styles.statusSection}>
          <div className={styles.healthIndicator}>
            <button
              className={`${styles.statusButton} ${getStatusClass(healthStatus?.status)}`}
            ...
            >
              <span className={styles.statusDot} aria-hidden="true"></span>
                  <span className={styles.statusText}>
                    {isLoading ? 'Checking...' : getStatusText(healthStatus?.status ?? 'unknown')}
                  </span>
              <svg
                className={`${styles.chevron} ${showHealthDetails ? styles.rotated : ''}`}
                width="16"
                height="16"
                viewBox="0 0 24 24"
                fill="none"
