...
let globalAlertTrigger: ((alert: Omit<NotificationAlert, 'id' | 'timestamp' | 'played'>) => void) | null = null;

export function setGlobalAlertTrigger(trigger: (alert: Omit<NotificationAlert, 'id' | 'timestamp' | 'played'>) => void) {
  globalAlertTrigger = trigger;
}

export function triggerGlobalAlert(alert: Omit<NotificationAlert, 'id' | 'timestamp' | 'played'>) {
