...
/// Simplified type-safe wrapper for Any operations
/// Note: Using simplified approach due to erased-serde API changes
pub struct SafeAny {
...
// TypeSafeCacheManager removed due to complexity - use CacheManager instead
