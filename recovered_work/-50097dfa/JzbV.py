...
class AudioQualityMetrics:
    ...
    dbtp_max: float  # Maximum true peak
    dbtp_min: float  # Minimum true peak
    dbtp_range: float  # Peak-to-peak range
    ...
    def analyze_audio_quality(
        ...
        try:
            ...
            metrics = AudioQualityMetrics(
                ...
                dbtp_max=self._calculate_true_peak_max_db(audio_array),
                dbtp_min=self._calculate_true_peak_min_db(audio_array),
                dbtp_range=self._calculate_peak_range_db(audio_array),
