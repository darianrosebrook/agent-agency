        ...
        Ok(agent_agency_contracts::working_spec::WorkingSpecContext {
            ...
            environment: context
                .map(|c| match c.environment {
                    agent_agency_contracts::task_request::Environment::Development => agent_agency_contracts::working_spec::WorkingSpecEnvironment::Development,
                    agent_agency_contracts::task_request::Environment::Staging => agent_agency_contracts::working_spec::WorkingSpecEnvironment::Staging,
                    agent_agency_contracts::task_request::Environment::Production => agent_agency_contracts::working_spec::WorkingSpecEnvironment::Production,
                })
                .unwrap_or(agent_agency_contracts::working_spec::WorkingSpecEnvironment::Development),
        })
    }
}
