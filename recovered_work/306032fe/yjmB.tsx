          ...
          <div className={styles.tabContent}>
            ...
            {state.activeTab === "query" && (
              <QueryBuilder
                ...
                onQueryExecute={async (query) => {
                  setState(prev => ({ ...prev, isExecutingQuery: true, queryError: null }));
                  try {
                    const result = await databaseApiClient.executeQuery({
                      sql: query,
                      parameters: [],
                    });
                    setState(prev => ({
                ...
                onSearch={async (query) => {
                  ...
                  try {
                    ...
                    setState(prev => ({
                      ...prev,
                      isSearching: false,
                      searchError: error instanceof Error ? error.message : "Vector search failed",
                    }));
                  }
                }}
            ...
            {state.activeTab === "quality" && (
              <DataQualityDashboard
                ...
                onRefresh={async () => {
                  setState(prev => ({ ...prev, isLoadingMetrics: true, metricsError: null }));
                  try {
            ...
            <div className={styles.sidebar}>
              <TableViewer
                ...
                onQuery={async (query) => {
                  ...
                  setState(prev => ({ ...prev, isLoadingTableData: true, tableError: null }));
                  try {
                    ...
                    setState(prev => ({
                      ...prev,
                      isLoadingTableData: false,
                      tableError: error instanceof Error ? error.message : "Table query failed",
                    }));
                  }
                }}
