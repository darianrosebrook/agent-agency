...
impl DatabaseArtifactStorage {
    ...
    fn map_code_changes(&self, artifacts_by_type: &std::collections::HashMap<String, Vec<serde_json::Value>>) -> agent_agency_contracts::execution_artifacts::CodeChangeStats {
        use agent_agency_contracts::execution_artifacts::*;
