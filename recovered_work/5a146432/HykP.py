...
class TTFAStats:
    ...
    def update(self, ttfa_ms: float):
        ...
        if ttfa_ms > 0:
            ...
            # TODO: Migrate from legacy simple average to statistical measures
            # - [ ] Deprecate _total_ttfa and average_ttfa attributes
            # - [ ] Update all consumers to use statistical measures (p50, p95)
            # - [ ] Add migration period with warnings for old attributes
