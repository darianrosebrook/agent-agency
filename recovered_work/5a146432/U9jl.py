...
class TTFAStats:
    ...
    def update(self, ttfa_ms: float):
        ...
        if ttfa_ms > 0:
            ...
            # - [ ] Replace cumulative average with exponential moving average (EMA)
            # - [ ] Add configurable window size for moving average calculation
            # - [ ] Implement weighted moving average for recent measurements
            # - [ ] Add statistical measures (median, percentiles) alongside mean
            # - [ ] Consider drift detection using moving average trends
