...
impl AuditedOrchestrator {
            ...
            Err(waiver_request) => {
                ...
                self.audit_manager.file_operations_auditor()
                    .record_budget_violation(
                        ...
                        &waiver_request.id,
                        &waiver_json,
                        matches!(waiver_request.risk_assessment, file_ops::RiskLevel::Critical),
                    ).await?;
    ...
    pub async fn approve_waiver(
        ...
        self.audit_manager.file_operations_auditor()
            .record_waiver_approval("manual", waiver_id, &waiver_json)
            .await?;
