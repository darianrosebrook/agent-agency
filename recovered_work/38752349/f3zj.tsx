      ...
      <div className={styles.metrics}>
        ...
        <div className={styles.metricGrid}>
          <div className={styles.metric}>
            ...
            <div
              className={`${styles.value} ${
                metrics.quality_delta >= 0 ? styles.positive : styles.negative
              }`}
            >
              {metrics.quality_delta >= 0 ? "+" : ""}
              {metrics.quality_delta.toFixed(3)}
            </div>
          ...
          <div className={styles.metric}>
            ...
            <div
              className={`${styles.value} ${
                metrics.iterations_saved > 0 ? styles.positive : styles.neutral
              }`}
            >
              {metrics.iterations_saved > 0 ? "+" : ""}
              {metrics.iterations_saved}
            </div>
            <div className={styles.threshold}>
          ...
          <div className={styles.metric}>
            ...
            <div
              className={`${styles.value} ${getThresholdStatus(
                metrics.cost_benefit_ratio,
                thresholds.cost_benefit_ratio
              )}`}
            >
          ...
          <div className={styles.metric}>
            ...
            <div
              className={`${styles.value} ${
                metrics.stopped_early ? styles.good : styles.neutral
              }`}
            >
          ...
          <div className={styles.flow}>
            ...
            <div
              className={`${styles.step} ${
                metrics.stopped_early ? styles.earlyStop : styles.completed
              }`}
            >
              ...
              <div className={styles.stepLabel}>
                Check Satisficing
                {metrics.stopped_early && (
                  <span className={styles.stopReason}>(Early Stop)</span>
                )}
              </div>
            </div>
            ...
            >
              ...
              <div className={styles.stepLabel}>
                ...
                {metrics.ceiling_detected && (
                  <span className={styles.stopReason}>(Ceiling Detected)</span>
                )}
              </div>
            </div>
        ...
        <div className={styles.insights}>
          ...
          <div className={styles.insightGrid}>
            ...
            <div className={styles.insight}>
              ...
              <p>
                {metrics.quality_delta > 0
                  ? `Achieved ${metrics.quality_delta.toFixed(
                      3
                    )} quality improvement across iterations.`
                  : `Quality ${Math.abs(metrics.quality_delta).toFixed(
                      3
                    )} units worse than initial attempt.`}
              </p>
            </div>
            ...
            <div className={styles.insight}>
              ...
              <p>
                Cost-benefit ratio of {metrics.cost_benefit_ratio.toFixed(3)}{" "}
                indicates
                {metrics.cost_benefit_ratio >= thresholds.cost_benefit_ratio
