...
interface TTSSettingsPanelProps {
  ...
  onVoiceChatSettingsChange?: (settings: import("@/types/chat").VoiceChatSettings) => void;
  className?: string;
}
            ...
            <div className={styles.settingGroup}>
              <label className={styles.label}>
                ...
                >
                  ...
                  <option value="voice_input">Voice Input → Text Response</option>
                  <option value="voice_output">Text Input → Voice Response</option>
