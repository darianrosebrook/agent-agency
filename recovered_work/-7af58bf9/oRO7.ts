...
export class ApiClient {
  ...
  async getTasks(_filters?: Record<string, unknown>): Promise<{
    ...
    console.warn("getTasks using mock implementation - V3 task API not available");
  ...
  async getTask(_taskId: string): Promise<{
    ...
    console.warn("getTask using mock implementation - V3 task detail API not available");
  ...
  async createChatSession(): Promise<{ sessionId: string; createdAt: string }> {
    console.warn("createChatSession using mock implementation - V3 backend not available");
