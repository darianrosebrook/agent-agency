...
// use crate::evaluation::EvaluationOrchestrator; // TEMP: disabled
...
// TEMP: Simple evaluation stub until council torch deps resolved
#[derive(Debug)]
pub struct SimpleEvaluationOrchestrator;

impl SimpleEvaluationOrchestrator {
    pub fn new() -> Self {
        Self
    }

    pub async fn evaluate(&self, _output: &str) -> f64 {
        // Simple stub: return random score between 0.5-0.9
