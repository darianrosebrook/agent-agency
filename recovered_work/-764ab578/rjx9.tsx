...
export default function AgentPerformanceGrid({
  ...
  const loadAgentPerformance = async () => {
    ...
    try {
      console.log("Starting agent performance load...");
      setIsLoading(true);
      setError(null);

      const agentData = await metricsApiClient.getAgentPerformance();
      console.log("Agent performance data loaded:", agentData?.length, "agents");
      setAgents(agentData);
    } catch (err) {
      const errorMessage =
      ...
      console.log("Agent performance load failed:", errorMessage);
      setError(errorMessage);
      console.error("Failed to load agent performance:", err);
    } finally {
      console.log("Agent performance load finished, isLoading:", false);
      setIsLoading(false);
    }
  };
