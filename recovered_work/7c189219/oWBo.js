...
describe('Scope Conflict Detection', () => {
  ...
  describe('Specs Conflicts Command', () => {
    test('should call scope conflict detection', async () => {
      ...
      require('../src/utils/spec-resolver').checkScopeConflicts = jest.fn().mockResolvedValue(mockConflicts);
      require('../src/commands/specs').loadSpecsRegistry = jest.fn().mockResolvedValue(mockRegistry);
  ...
  describe('Validation Integration', () => {
    test('should include scope conflicts in validation output', async () => {
      ...
      expect(console.log).toHaveBeenCalledWith(
        expect.stringContaining('Scope conflicts detected')
      );
    });
  });
});
