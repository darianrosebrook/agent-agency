...
export class ChatApiClient {
  ...
  async sendMessage(
    ...
    try {
      ...
      throw new ChatApiError("server_error", "Failed to send message", true);
    }
  }
  ...
  async pauseSession(sessionId: string): Promise<ChatSession> {
    try {
      ...
      throw new ChatApiError("server_error", "Failed to pause session", true);
    }
  }
  ...
  async resumeSession(sessionId: string): Promise<ChatSession> {
    try {
      ...
      throw new ChatApiError("server_error", "Failed to resume session", true);
    }
  }
  ...
  async deleteSession(sessionId: string): Promise<void> {
    try {
      ...
      throw new ChatApiError("server_error", "Failed to delete session", true);
    }
  }
