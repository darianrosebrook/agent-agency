            ...
            <div className="empty-state">
              <div className="empty-state-content">
                ...
                <p className="empty-state-description">
                  Chat with the autonomous agent system to initiate tasks,
                  monitor progress, and provide guidance. This feature requires
                  a WebSocket connection to the V3 backend chat service.
                </p>
