...
import { FolderPlus, Plus, Search, Filter, Clock, ChevronDown, ChevronUp, ChevronsUpDown } from 'lucide-react';
...
export function Projects() {
  const { projects, currentProjectId, getCurrentProject, createProject, selectProject, clearCurrentProject } = useProjectContext();
  ...
  const handleCreateProject = (data: { name: string; summary?: string; description?: string; milestones?: string[] }) => {
    createProject(data);
  };
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {project.summary && (
                      <p className="text-sm text-gray-500 mb-1 truncate">{project.summary}</p>
                    )}
          ...
          {sortedProjects.length > 0 && (
            <div className="flex items-center justify-between px-6 py-4 border-t border-gray-800">
              <div className="flex items-center gap-2 text-sm text-gray-400">
                ...
                <span>
                  of {sortedProjects.length} {sortedProjects.length === 1 ? 'project' : 'projects'}
                </span>
              </div>
