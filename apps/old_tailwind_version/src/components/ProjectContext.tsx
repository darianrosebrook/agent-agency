...
interface ProjectContextType {
  ...
  createProject: (data: { name: string; summary?: string; description?: string; milestones?: string[] }) => string;
...
export function ProjectProvider({ children }: { children: ReactNode }) {
  ...
  const createProject = (data: { name: string; summary?: string; description?: string; milestones?: string[] }) => {
