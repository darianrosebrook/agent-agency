    ...
    <div className="w-full">
      ...
      <div className="mb-6">
        ...
        <p className="text-zinc-400 mb-4">
          Here's a comprehensive plan for building your
          multi-modal RAG search UI tool
        </p>
                      ...
                      <div className="space-y-2 mb-4 ml-8">
                        {task.subtasks.map((subtask) => (
                          ...
                          >
                            ...
                            <span
                              className={`flex-1 text-sm ${subtask.completed ? "text-zinc-500 line-through" : "text-zinc-300"}`}
                            >
                              {subtask.text}
                            </span>
                            <button
