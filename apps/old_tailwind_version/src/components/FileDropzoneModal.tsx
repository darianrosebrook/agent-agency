...
export function FileDropzoneModal({ open, onOpenChange, onFilesAdded }: FileDropzoneModalProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-[#1a1a1a] border-gray-800 max-w-md">
        ...
        <DialogDescription className="sr-only">
          {isUploading ? 'Please wait while we import your files' : 'Drag and drop files or browse to upload'}
        </DialogDescription>
        {!isUploading ? (
          <div
          ...
          <div className="flex flex-col items-center justify-center py-12 px-6">
            ...
            <p className="text-gray-400 text-sm text-center mb-6">
              Please wait a few seconds while we're<br />importing your data to the project
            </p>
