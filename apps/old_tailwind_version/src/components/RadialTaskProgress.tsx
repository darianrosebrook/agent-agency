...
import { CheckCircle2, MoreVertical, ChevronLeft, ChevronRight } from 'lucide-react';
...
const recentProjects: Project[] = [
  {
    ...
    description: "Building a modern shopping experience with AI recommendations",
    progress: 78,
    status: "On Track",
    date: "March 11, 2025",
...
export function RadialTaskProgress({
  ...
  const handleNext = () => {
    setCurrentIndex((prev) => (prev === recentProjects.length - 1 ? 0 : prev + 1));
  };
  ...
  const completedSegments = Math.round((currentProject.progress / 100) * totalSegments);
