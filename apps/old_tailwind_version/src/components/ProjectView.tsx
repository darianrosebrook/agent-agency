...
export function ProjectView({ projectName, onBackToProjects }: ProjectViewProps) {
            ...
            <div className="h-[35.994px] relative shrink-0">
              <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[35.994px] relative flex gap-[24px] items-start">
                {tabs.map((tab, index) => (
                  ...
                  >
                    <p className={`font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic text-[16px] text-nowrap tracking-[-0.3125px] whitespace-pre transition-colors ${
                      activeTab === tab.id ? 'text-white' : 'text-[#888888] hover:text-gray-300'
                    }`}>
                      {tab.label}
                    </p>
                    {activeTab === tab.id && (
              ...
              <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[35.994px] relative flex gap-[12px] items-center">
                ...
                <div className="relative h-[35.994px] w-[255.994px] shrink-0">
                  ...
                  <div className="absolute left-[12px] size-[15.994px] top-[10px]">
                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
                      <path d={svgPaths.p24791400} stroke="#888888" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33286" />
                      <path d={svgPaths.p2139fb00} stroke="#888888" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33286" />
                    </svg>
                  </div>
                  {/* Keyboard Shortcut */}
                ...
                <button className="bg-[#1a1a1a] h-[35.994px] rounded-[8px] px-4 relative shrink-0 hover:bg-[#252525] transition-colors">
                  ...
                  <div className="flex items-center gap-2 h-full whitespace-nowrap">
                    <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic text-[14px] text-white tracking-[-0.1504px]">Status: All</p>
                    <div className="size-[15.994px] shrink-0">
                      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
                        <path d={svgPaths.p10a02b40} stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33286" />
                      </svg>
                    </div>
                  </div>
                </button>
                ...
                <button className="bg-[#1a1a1a] h-[35.994px] rounded-[8px] px-4 relative shrink-0 hover:bg-[#252525] transition-colors">
                  ...
                  <div className="flex items-center gap-2 h-full whitespace-nowrap">
                    <div className="size-[15.994px] shrink-0">
                      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
                        <path d={svgPaths.p26dba700} stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33286" />
                        <path d="M11.3293 13.3286V2.66572" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33286" />
                        <path d={svgPaths.pea98c00} stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33286" />
                        <path d="M4.66501 2.66572V13.3286" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33286" />
                      </svg>
                    </div>
                    <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic text-[14px] text-white tracking-[-0.1504px]">Sort</p>
                  </div>
                </button>
                ...
                <button className="bg-[#1a1a1a] box-border content-stretch flex h-[35.994px] items-center justify-center p-[0.909px] rounded-[8px] w-[41.804px] shrink-0 relative hover:bg-[#252525] transition-colors">
                  ...
                  <div className="shrink-0 size-[15.994px]">
                    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
                      <path d={svgPaths.p3cc8d400} stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33286" />
                      <path d="M1.99929 5.99787H13.995" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33286" />
                      <path d="M1.99929 9.99645H13.995" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33286" />
                      <path d="M5.99787 1.99929V13.995" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33286" />
                      <path d="M9.99645 1.99929V13.995" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33286" />
                    </svg>
                  </div>
                </button>
              </div>
