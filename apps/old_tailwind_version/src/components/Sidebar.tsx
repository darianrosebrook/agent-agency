...
export function Sidebar() {
  ...
  return (
    <aside
      className={`${isCollapsed ? "w-16" : "w-80"} bg-[#1a1a1a] border-r border-gray-800 flex flex-col h-screen transition-all duration-300`}
    >
      {/* Header */}
      <div
      ...
      >
        <div
          className={`flex items-center ${isCollapsed ? "justify-center mb-3" : "justify-between mb-6"}`}
        >
          {!isCollapsed && (
            <div className="flex items-center gap-2">
              ...
              <h4 className="inline text-white">
                Agent Agency
              </h4>
            </div>
          )}
        ...
        <TooltipProvider>
          <div
            className={`${isCollapsed ? "mt-0" : "mt-4"} space-y-1`}
          >
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  to="/chat"
                  className={`w-full flex items-center ${isCollapsed ? "justify-center" : "gap-3"} px-3 py-2 text-gray-300 hover:bg-gray-800/50 rounded-lg`}
                >
      ...
      {/* Navigation */}
      <nav
        className={`flex-1 ${isCollapsed ? "p-2" : "p-4"} overflow-y-auto`}
      >
        <TooltipProvider>
          <div className="space-y-1">
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  to="/"
                  className={`w-full flex items-center ${isCollapsed ? "justify-center" : "gap-3"} px-3 py-2 rounded-lg ${
                    isActive("/")
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  ...
                  {!isCollapsed && (
                    <span className="text-sm">Agent Stats</span>
                  )}
                </button>
              </TooltipTrigger>
              {isCollapsed && (
