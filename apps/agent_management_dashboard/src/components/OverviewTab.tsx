...
import { OverviewEditor } from "./composers/editor";
...
export function OverviewTab() {
  ...
  return (
    <div className={styles.overviewTab}>
      ...
      >
        {showMetadata ? (
          <PanelRightClose className={styles.toggleButtonIcon} />
        ) : (
          <PanelRightOpen className={styles.toggleButtonIcon} />
        )}
      </button>
...
function EditorToolbar() {
  return (
    <div className={styles.toolbarContainer}>
      {/* Bold Button */}
      <button className={cn(styles.toolbarButton, styles.toolbarButtonBold)}>
        <div className={styles.toolbarButtonIcon}>
          <svg
      ...
      {/* Italic Button */}
      <button className={cn(styles.toolbarButton, styles.toolbarButtonItalic)}>
        <div className={styles.toolbarButtonIcon}>
          <svg
            className={styles.svgIcon}
            fill="none"
  ...
  return (
    <div className={styles.editorPlaceholder}>
      ...
      <div className={styles.editorPlaceholderHeading}>
        <h1 className={styles.editorPlaceholderHeading1}>
          Project Vision
        </h1>
      </div>
      ...
      {/* Another section */}
      <div className={styles.editorPlaceholderSection}>
        <h2 className={styles.editorPlaceholderHeading2}>
          Key Objectives
        </h2>
        <p className={styles.editorPlaceholderText}>
