...
import { getApiKeys, createApiKey, revokeApiKey, deleteApiKey, ApiKey } from '@/lib/api/settings';
              ...
              apiKeys.map((key) => (
                <div key={key.id} className={styles.keyItem}>
                  ...
                  <div className={styles.keyActions}>
                    {key.is_active ? (
                      <Button onClick={() => handleRevokeKey(key.id)} variant="destructive">
                        Revoke
                      </Button>
                    ) : (
                      <Button onClick={() => handleDeleteKey(key.id)} variant="destructive">
                        Delete
                      </Button>
                    )}
                  </div>
