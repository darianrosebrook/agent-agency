 ...
 */
export function validateTaskResponse(data: unknown): TaskWithOptionalDescription {
...
export function safeValidateTaskResponse(
  data: unknown
): TaskWithOptionalDescription | null {
 ...
 * @throws ZodError if validation fails
 */
export function validateTaskArray(data: unknown): TaskWithOptionalDescription[] {
...
export function safeValidateTaskArray(
  ...
  const results: TaskWithOptionalDescription[] = [];
...
export function validateTaskResponseDetailed(
  data: unknown
): ValidationResult<TaskWithOptionalDescription> {
  const result = ProjectTaskSchema.safeParse(data);
 ...
 */
export function isTaskLike(data: unknown): data is Partial<Task> {
