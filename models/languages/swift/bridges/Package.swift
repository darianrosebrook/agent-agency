...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "Audio.STT.Whisper", dependencies: ["Core","Audio.Utils", .product(name: "WhisperKit", package: "whisperkit")],
        ...
        .target(name: "Vision.OD.YOLO", dependencies: ["Core","Vision.ImageUtils","System.ModelMgmt"],
                path: "Sources/Vision/ObjectDetection/YOLO",
                swiftSettings: [.define("ENABLE_VISION_BRIDGES")]),
        .target(name: "Vision.OCR.VisionOCR", dependencies: ["Core","Vision.ImageUtils","System.ModelMgmt"],
                path: "Sources/Vision/OCR",
                swiftSettings: [.define("ENABLE_VISION_BRIDGES")]),
        .target(name: "Vision.Classification.FastViT", dependencies: ["Core","Vision.ImageUtils","System.ModelMgmt"],
                path: "Sources/Vision/Classification/FastViT",
                swiftSettings: [.define("ENABLE_VISION_BRIDGES")]),
        ...
        .target(name: "Text.LLM.Mistral", dependencies: ["Core","Text.Tokenization","System.ModelMgmt"],
                path: "Sources/Text/LanguageModels/Mistral",
                swiftSettings: [.define("ENABLE_TEXT_BRIDGES")]),
        .target(name: "Text.Generation.Diffusion", dependencies: ["Core","System.ModelMgmt"],
        ...
        .target(name: "BridgesFFI",
                dependencies: ["Core","System.ModelMgmt",
                               ...
                               "Vision.OD.YOLO","Vision.OCR.VisionOCR","Vision.Classification.FastViT",
        ...
        .target(name: "AgentBridges",
                dependencies: ["Core",
                               ...
                               "Vision.OD.YOLO","Vision.OCR.VisionOCR","Vision.Classification.FastViT","Vision.ImageUtils",
        ...
        .testTarget(name: "VisionTests", dependencies: ["Vision.OD.YOLO","Vision.OCR.VisionOCR","Vision.Classification.FastViT","BridgesFFI"], path: "Tests/VisionTests"),
